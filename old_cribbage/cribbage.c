...
void print_hand(char name[], int hand[], int playerNumber, int cribTracker) {
	...
	for (int i = 0; i < HAND_COUNT; ++i) {
		switch (hand[i] % 4) {
			case 0: strcpy(suite,"diamonds"); break; 
			case 1: strcpy(suite, "hearts"); break; 
			case 2: strcpy(suite, "clubs"); break; 
			case 3: strcpy(suite, "spades"); break;
		}
		switch (hand[i] / 4) {
			case 0: printf("[%d] Ace of %s\n", i, suite); break;
			case 10: printf("[%d] Jack of %s\n", i, suite); break;
			case 11: printf("[%d] Queen of %s\n", i, suite); break;
			case 12: printf("[%d] King of %s\n", i, suite); break;
			case 50: break;
			default: printf("[%d] %d of %s\n", i, (hand[i] / 4)+1, suite); break;
		}
	}
}
...
void get_cut(int usedCards[], int *cut, char name1[], char name2[], int *name1Score, int *name2Score, int cribTracker) {
	...
	if (usedCards[card] == 0) {
		*cut = card;
		...
		switch (card / 4) {
			case 0: printf("Ace of %s\n", suite); break;
			case 10: printf("Jack of %s\n", suite); break;
			case 11: printf("Queen of %s\n", suite); break;
			case 12: printf("King of %s\n", suite); break;
			default: printf("%d of %s\n", (card / 4)+1, suite); break;
		}
	}
}
